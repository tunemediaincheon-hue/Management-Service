...
export const DEFAULT_SETTINGS: SiteSettings = {
  metaTitle: "온리움디엔씨 | 온리움디엔씨 공간 DT 전문 브랜드 튠 미디어",
  metaDescription: "주식회사 온리움디엔씨는 공간 DT 전문 브랜드 튠 미디어(tunemedia)를 두고, 디지털 사이니지, AI 비전 분석, IoT 연동 센서 등을 활용하여 혁신적인 오프라인 디지털 트랜스포메이션을 제공합니다.",
  metaKeywords: "온리움디엔씨, 온리움D&C, tunemedia, 튠 미디어, 툰미디어, 공간DT, 디지털트랜스포메이션, 디지털사이니지, AI비전, 매장분석, IoT센서",
  ogImage: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&q=80&w=1200",
  logoText: "온리움디엔씨",
  logoSubText: "tunemedia solution",
  accentColor: "#2563EB", // Blue-600
  fontFamily: "sans",
  heroBadge: "ONRIUM D&C | TUNEMEDIA SPACE DT",
  heroTitle: "고객과 함께 오프라인 공간의 가치를 높입니다.",
  heroSubtitle: "Tuning every moment with Tune Media under ONRIUM D&C_",
  ...
  companyName: "주식회사 온리움디엔씨 (ONRIUM D&C Co., Ltd.)",
  ceo: "주현정",
  address: "인천광역시 미추홀구 석정로 229, 5층 (도화동, 행정타운 및 JST)",
  phone: "010-9654-9882",
  email: "tunemediaincheon@gmail.com",
  registrationNumber: "589-19-02880"
};
...
export const DEFAULT_BLOGS: BlogPost[] = [
  ...
  },
  {
    ...
    content: "기후 위기 시대에 공간을 소유하고 운영하는 모든 비즈니스 운영자들에게 'ESG 경영 및 관리 비용 최적화'는 필수적인 어젠다가 되었습니다.\n\n인원 수 대비 지나치게 세게 가동되는 냉난방기, 혹은 아무도 머물지 않는데 대낮처럼 환히 켜진 외곽 조명 등은 매달 고정비 상승의 원인입니다. 온리움디엔씨 튠미디어의 IoT 스마트 공간 자동화 솔루션은 저전력 무선 블루투스 메시(BLE Mesh) 기술을 토대로 매장의 모든 콘센트, 공조 장치, 조명을 중앙 지능형 코어와 통합시킵니다.\n\n특히 당사 AI 비전과 IoT 센서망의 '상호 연동 크로스 컨트롤'을 도입하면, 방문객 밀집도가 50% 미만인 시간대에는 구역별 조도를 자연 채광 밝기에 맞춰 최적 수준으로 조절하고, 매장 미운영 시간에는 불필요한 대기 전력을 완전 차단합니다. 24시간 공간을 직접 순찰하고 켜고 끌 필요 없이, 미리 정의된 소프트웨어 시나리오에 의해 조작되는 온리움디엔씨 튠미디어의 무선 메시 솔루션으로 공간의 품격과 효율을 동시에 업그레이드 하십시오.",
